...
from homeassistant.components.ocleanx.package.parser import OcleanXBluetoothDeviceData
...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    """Set up OcleanX BLE device from a config entry."""
    address = entry.unique_id
    assert address is not None
    data = OcleanXBluetoothDeviceData()
